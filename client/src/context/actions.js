...
export const FUND_USER_WALLET_BEGIN = " FUND_USER_WALLET_BEGIN";
export const FUND_USER_WALLET_SUCCESS = "FUND_USER_WALLET_SUCCESS";
export const FUND_USER_WALLET_ERROR = " FUND_USER_WALLET_ERROR";

export const SEARCH_USER_TRANSACTION_BEGIN = " SEARCH_USER_TRANSACTION_BEGIN";
export const SEARCH_USER_TRANSACTION_SUCCESS =
  "SEARCH_USER_TRANSACTION_SUCCESS";
export const SEARCH_USER_TRANSACTION_ERROR = " SEARCH_USER_TRANSACTION_ERROR";
